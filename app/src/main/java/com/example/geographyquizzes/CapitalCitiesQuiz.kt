...
import com.example.geographyquizzes.databinding.ActivityCapitalCitiesQuizBinding

class CapitalCitiesQuiz : AppCompatActivity(), View.OnClickListener {

    private var binding : ActivityCapitalCitiesQuizBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCapitalCitiesQuizBinding.inflate(layoutInflater)
        setContentView(binding?.root)

        // Initialise in the questions list
        questionsList = Constants.getCapitalCitiesQuizQuestions()
    ...
    fun setQuestion() {
        ...
        binding?.tvProgressText?.text = "$currentPosition/${binding?.progressBar?.max}"
        ...
        when (button?.id) {
            ...
            binding?.btnSubmit?.id -> {
                ...
                if (selectedOption == null) {
                    Toast.makeText(this@CapitalCitiesQuiz, "Please select an answer", Toast.LENGTH_SHORT).show()
                }
                /*
             ...
             */
                else if (binding?.btnSubmit?.text.toString() == getString(R.string.submit)) {
                 ...
                 */
                    ...
                    intent.putExtra(Constants.QUIZ_TAKEN, "Capital Cities Quiz")
