...
import com.example.geographyquizzes.databinding.ActivityCountryOutlineQuizBinding

class CountryOutlineQuiz : AppCompatActivity(), View.OnClickListener {

    private var binding: ActivityCountryOutlineQuizBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCountryOutlineQuizBinding.inflate(layoutInflater)
        setContentView(binding?.root)

        // Initialise in the questions list
        questionsList = Constants.getCountryOutlineQuizQuestions()
    ...
    fun setQuestion() {
        ...
        binding?.ivCountryOutline?.setImageResource(question.flag)
        ...
        when (button?.id) {
            ...
            binding?.btnSubmit?.id -> {
                ...
                if (selectedOption == null) {
                    Toast.makeText(this@CountryOutlineQuiz, "Please select an answer", Toast.LENGTH_SHORT).show()
                }
                /*
             ...
             */
                 ...
                 */
                    ...
                    intent.putExtra(Constants.QUIZ_TAKEN, "Country Outline Quiz")
